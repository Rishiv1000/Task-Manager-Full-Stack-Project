...
const Signup = () => {
  ...
  return (
    <div className="h-[98vh] flex flex-col items-center justify-center bg-gray-900">
      {/* Heading */}
      <h1 className="text-4xl font-bold text-white mb-8">YOUR TASK MANAGER</h1>
      ...
      <div className="p-8 w-96 rounded-lg bg-gradient-to-br from-blue-600 to-teal-600 shadow-xl">
        <div className="text-3xl font-semibold text-gray-800 text-center mb-6">Sign Up</div>
        ...
        <input
          ...
          name="username"
          className="bg-black px-4 py-3 my-3 w-full text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-300 transition duration-300 ease-in-out"
          onChange={change}
          value={Data.username}
        />
        <input
        ...
        <div className="w-full flex items-center justify-between mt-6">
          <button
            className="bg-gray-900 text-xl font-semibold text-white px-6 py-3 rounded-lg hover:bg-gray-700 transition duration-300 w-full"
            onClick={submit}
          >
            Sign Up
          </button>
